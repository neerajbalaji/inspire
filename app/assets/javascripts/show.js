        ...
        youtubeVideoGallery:function(options) {
            var version = '1.3.0',
                ...
                defaults = {
                    ...
                    forceLegacyIE:false,
                    iframeTemplate:'<iframe title="Youtube video player" id="youtube-videogallery-iframe" style="height:{options.innerHeight}px;width:{options.innerWidth}px;" frameborder="0" allowfullscreen="1" src="about:blank" />',
                    innerHeight:800,
                    innerWidth:1200,
